...
class IndexController extends CommonController {
    ...
    public function index() {
        ...
        if (!ECTouch::view()->is_cached('index.dwt', $cache_id))
        {
            /*********************************/
            //自定义形尚首页4类商品
            $mobile_main_1 = model('MobileMain')->get_row(1);
            $mobile_main_2 = model('MobileMain')->get_row(2);
            $mobile_main_3 = model('MobileMain')->get_row(3);
            $mobile_main_4 = model('MobileMain')->get_row(4);
            $this->assign('mobile_main_1',$mobile_main_1);
            $this->assign('mobile_main_2',$mobile_main_2);
            $this->assign('mobile_main_3',$mobile_main_3);
            $this->assign('mobile_main_4',$mobile_main_4);
            /*********************************/
            // 自定义导航栏
