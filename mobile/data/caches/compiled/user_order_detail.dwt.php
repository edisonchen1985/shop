...
<div class="two-btn ect-padding-tb ect-padding-lr ect-margin-tb text-center"> 
  <?php echo $this->_var['order']['handler']; ?> 
    ...
    <a href="<?php echo url('user/order_tracking', array('order_id'=>$this->_var['order']['order_id']));?>" type="button" class="btn btn-info ect-btn-info ect-colorf ect-bg"><?php echo $this->_var['lang']['order_tracking']; ?></a>
    <?php endif; ?>
</div>
