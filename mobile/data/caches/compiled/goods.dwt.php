...
?>
              <input class="is_shoes" type="radio" name="spec_<?php echo $this->_var['spec_key']; ?>" value="<?php echo $this->_var['value']['id']; ?>" id="spec_value_<?php echo $this->_var['value']['id']; ?>" <?php if ($this->_var['key'] == 0): ?>checked<?php endif; ?> onclick="changePrice()" />
...
?>
  ...
  <div class="popGeneral" id="popDiv" >
    <div class="tit">
      <h4><?php echo $this->_var['lang']['add_to_cart']; ?></h4>
      <span class="ico_08" onclick="closeDiv()"><a href="javascript:"></a></span> </div>
    <div id="main">
      <div id="left"> <img style="width:8rem;height:auto;" src="<?php echo $this->_var['goods']['goods_thumb']; ?>"> </div>
      <div id="right">
        <p><?php echo $this->_var['goods']['goods_name']; ?></p>
        <span> 加入数量： <b id="cartNum"></b></span> <span> 总计金额： <b id="cartPrice"></b></span> 
      </div>
    </div>
    <div class="popbtn"> <a class="bnt1 flex_in radius5" onclick="closeDiv()" href="javascript:void(0);">继续购物</a> <a class="bnt2 flex_in radius5" href="<?php echo url('flow/cart');?>"><?php echo $this->_var['lang']['check_out']; ?></a> </div>
  </div>
  ...
  <div class="goods-related ect-padding-lr ect-padding-tb">
    ...
    <div id="picScroll" class="picScroll">
      ...
      <div class="bd">
        <ul>
          <?php $_from = $this->_var['related_goods']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'goods_0_52349500_1496411442');$this->_foreach['goods'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['goods']['total'] > 0):
    foreach ($_from AS $this->_var['goods_0_52349500_1496411442']):
        $this->_foreach['goods']['iteration']++;
?>
          <li><a href="<?php echo $this->_var['goods_0_52349500_1496411442']['url']; ?>"><img _src="<?php echo $this->_var['goods_0_52349500_1496411442']['goods_thumb']; ?>" src="<?php echo $this->_var['goods_0_52349500_1496411442']['goods_thumb']; ?>" /></a>
            <p class="ect-color"> 
              <?php if ($this->_var['goods_0_52349500_1496411442']['promote_price']): ?> 
              <?php echo $this->_var['goods_0_52349500_1496411442']['formated_promote_price']; ?>
              <?php else: ?> 
              <?php echo $this->_var['goods_0_52349500_1496411442']['shop_price']; ?>
              <?php endif; ?> 
            </p>
            <p class="text-left"><?php echo $this->_var['goods_0_52349500_1496411442']['short_name']; ?></p>
          </li>
...
<?php echo $this->fetch('library/page_footer_nav.lbi'); ?>
...
<script type="text/javascript">
				...
				$(function(){
					var user_recommendation = "<?php echo $this->_var['user_recommendation']; ?>";
