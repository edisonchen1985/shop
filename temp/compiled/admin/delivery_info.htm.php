...
<form action="order.php" method="post" name="theForm" onsubmit="return checkInvoice()">
  ...
  <tr>
    ...
    <td><?php if ($this->_var['delivery_order']['status'] != 1): ?><input name="invoice_no" type="text" value="<?php echo $this->_var['delivery_order']['invoice_no']; ?>" <?php if ($this->_var['delivery_order']['status'] == 0): ?> readonly="readonly" <?php endif; ?>><?php else: ?><?php echo $this->_var['delivery_order']['invoice_no']; ?><?php endif; ?></td>
