...
?>
        ...
        <tr>
         ...
         <table width="90%" id="detail-table" style="display:none">
          ...
          <tr>
            <td><?php echo $this->_var['goods_shipai']; ?></td>
          </tr>
        </table>
...
<!--            <td><input type="text" name="goods_number" value="<?php echo $this->_var['goods']['goods_number']; ?>" size="20" <?php if ($this->_var['code'] != '' || $this->_var['goods']['_attribute'] != ''): ?>readonly="readonly"<?php endif; ?> /><br />-->
        ...
        <table width="90%" id="properties-table" style="display:none" align="center">
          ...
          <tr>
            <td class="label">
	    	<?php if ($this->_var['goods']['is_shoes']): ?>
	    		<input type="radio" name="is_shoes" value="0">不需要形尚自动推荐
			<input type="radio" name="is_shoes" checked="checked" value="1">需要形尚自动推荐
		<?php else: ?>
	    		<input type="radio" name="is_shoes" checked="checked" value="0">不需要形尚自动推荐
			<input type="radio" name="is_shoes" value="1">需要形尚自动推荐
		<?php endif; ?>
	    </td>
            <td>
              <span class="notice-span" style="display:block">如果此商品是鞋，鞋垫并且需要形尚根据3D扫描结果自动推荐尺码时请勾选，并在上面的商品类型里选择该商品对外销售的尺码</span>
	    </td>
          </tr>
        </table>
        <?php endif; ?>
        ...
        <table width="90%" id="groupgoods-table" style="display:none" align="center">
          ...
          <tr>
            ...
            <td align="center">
              ...
              <p>套餐<br /><select name="group2"><option value="1">套餐一</option><option value="2">套餐二</option><option value="3">套餐三</option></select></p>
