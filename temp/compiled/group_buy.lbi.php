...
?>
        	<li style=" width:150px">
            	<a href="<?php echo $this->_var['goods']['url']; ?>" ><img src="<?php echo $this->_var['goods']['thumb']; ?>" alt="<?php echo htmlspecialchars($this->_var['goods']['goods_name']); ?>"  width="150" height="200"/></a>
                <div style=" clear:both"></div>
                <div class="t_buy_price">
               		<?php echo $this->_var['goods']['last_price']; ?>
            	</div>
                <a href="<?php echo $this->_var['goods']['url']; ?>" class="buy_btn"></a>
            </li>
