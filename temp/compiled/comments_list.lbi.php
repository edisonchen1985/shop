...
?>
<div class="comment_mainT">
	<div class="clearfix comment_mainT_tit">
    	<span>评论时间：<?php echo $this->_var['comment']['add_time']; ?></span>
        <span>来自：<?php if ($this->_var['comment']['username']): ?><?php echo htmlspecialchars($this->_var['comment']['username']); ?><?php else: ?><?php echo $this->_var['lang']['anonymous']; ?><?php endif; ?></span>
        <h3>
        	<strong class="vms">综合评分：<img src="themes/masamasuo/images/stars<?php echo $this->_var['comment']['rank']; ?>.gif" alt="<?php echo $this->_var['comment']['comment_rank']; ?>" /></strong>
        </h3>
    </div>
    <p class="comment_title" style="color:#000;">评论内容：<?php echo $this->_var['comment']['content']; ?></p>
</div>
<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
<?php else: ?>
<div class="comment_mainT"><p class="comment_title" style="color:#000;"><?php echo $this->_var['lang']['no_comments']; ?></p></div>
<?php endif; ?>
...
<div id="pagebar" class="f_r">
        ...
        <div id="pager">
          <?php echo $this->_var['lang']['pager_1']; ?><?php echo $this->_var['pager']['record_count']; ?><?php echo $this->_var['lang']['pager_2']; ?><?php echo $this->_var['lang']['pager_3']; ?><?php echo $this->_var['pager']['page_count']; ?><?php echo $this->_var['lang']['pager_4']; ?> <span> <a href="<?php echo $this->_var['pager']['page_first']; ?>"><?php echo $this->_var['lang']['page_first']; ?></a> <a href="<?php echo $this->_var['pager']['page_prev']; ?>"><?php echo $this->_var['lang']['page_prev']; ?></a> <a href="<?php echo $this->_var['pager']['page_next']; ?>"><?php echo $this->_var['lang']['page_next']; ?></a> <a href="<?php echo $this->_var['pager']['page_last']; ?>"><?php echo $this->_var['lang']['page_last']; ?></a> </span>
            <?php $_from = $this->_var['pager']['search']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'item_0_89918400_1496562091');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['item_0_89918400_1496562091']):
?>
            <input type="hidden" name="<?php echo $this->_var['key']; ?>" value="<?php echo $this->_var['item_0_89918400_1496562091']; ?>" />
            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
        </div>
        <?php else: ?>
         ...
         <div id="pager" class="pagebar">
          ...
          <?php $_from = $this->_var['pager']['page_number']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'item_0_89940900_1496562091');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['item_0_89940900_1496562091']):
?>
                <?php if ($this->_var['pager']['page'] == $this->_var['key']): ?>
                <span class="page_now"><?php echo $this->_var['key']; ?></span>
                <?php else: ?>
                <a href="<?php echo $this->_var['item_0_89940900_1496562091']; ?>">[<?php echo $this->_var['key']; ?>]</a>
                <?php endif; ?>
            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
          ...
          <?php if ($this->_var['pager']['page_kbd']): ?>
            <?php $_from = $this->_var['pager']['search']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'item_0_89967800_1496562091');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['item_0_89967800_1496562091']):
?>
            <input type="hidden" name="<?php echo $this->_var['key']; ?>" value="<?php echo $this->_var['item_0_89967800_1496562091']; ?>" />
            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                    ...
                    <td>
                      <table>
                        <tbody><tr>
                          ...
                          <td><input type="submit" value="提交评论" class="sub"></td>
                        </tr>
                      </tbody></table>
                    </td>
                  </tr>
...
//<![CDATA[
<?php $_from = $this->_var['lang']['cmt_lang']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'item_0_89998600_1496562091');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['item_0_89998600_1496562091']):
?>
var <?php echo $this->_var['key']; ?> = "<?php echo $this->_var['item_0_89998600_1496562091']; ?>";
<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
