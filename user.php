...
elseif ($action == 'act_register')
{
    ...
    else
    {
        ...
        $other['mobile_phone'] = isset($_POST['extend_field5']) ? $_POST['extend_field5'] : $username;
	...
	if(!($real_mobile_code = $mem->get("$username"))){
	    show_message('请先获取手机验证码');
	}else if($real_mobile_code != $mobile_code){
