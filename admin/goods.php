...
elseif ($_REQUEST['act'] == 'insert' || $_REQUEST['act'] == 'update')
{
    ...
    $is_shoes = empty($_POST['is_shoes']) ? 0 : intval($_POST['is_shoes']);
    ...
    if ($is_insert)
    {
        if ($code == '')
        {
            $sql = "INSERT INTO " . $ecs->table('goods') . " (is_shoes,goods_name, goods_name_style, goods_sn, " .
                ...
                "VALUES ('$is_shoes','$_POST[goods_name]', '$goods_name_style', '$goods_sn', '$catgory_id', " .
